...
func analyzeHandler(w http.ResponseWriter, r *http.Request) {
	...
	// 5. Build Final DOCX
	templatePath := "knowledge/Matrix_Asbestos_Blank_Template.docx"
...
func analyzeBucketHandler(w http.ResponseWriter, r *http.Request) {
	...
	outputPrefix := prefix
	if strings.HasPrefix(outputPrefix, "asbestos_inputs/") {
		outputPrefix = "asbestos_outputs/" + strings.TrimPrefix(outputPrefix, "asbestos_inputs/")
	} else if strings.HasPrefix(outputPrefix, "asbestos_inputs") { // edge case
		outputPrefix = "asbestos_outputs" + strings.TrimPrefix(outputPrefix, "asbestos_inputs")
	}
